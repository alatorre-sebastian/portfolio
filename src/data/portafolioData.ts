            ...
            <div class="flex flex-col items-center justify-center h-full space-y-6">
                ...
                <div data-pw-selector="locator('#contact-card')" id="contact-card" class="playwright-highlight flex flex-col items-center space-y-4 p-8 w-full max-w-md bg-[#161616] border border-zinc-800 rounded shadow-2xl">
                    ...
                    <div class="flex gap-4 w-full mt-4 pt-4 border-t border-zinc-800">
                        <a href="https://github.com/alatorre-sebastian" target="_blank" rel="noopener noreferrer" data-pw-selector="getByRole('link', { name: 'GitHub' })" class="flex-1 py-2 bg-zinc-800 hover:bg-zinc-700 text-white text-xs font-bold rounded transition-colors border border-zinc-600 flex justify-center items-center gap-2">
                        ...
                        <a href="https://www.linkedin.com/in/sebastian-alatorre-lopez-ba48b4206/" target="_blank" rel="noopener noreferrer" data-pw-selector="getByRole('link', { name: 'LinkedIn' })" class="flex-1 py-2 bg-[#0077b5]/20 hover:bg-[#0077b5]/40 text-white text-xs font-bold rounded transition-colors border border-[#0077b5]/50 flex justify-center items-center gap-2">
